...
public class MimeMailService {
	...
	public void sendMimeMail(String from, String[] to, String[] cc, String subject,
	...
	public void sendMimeMail(String from, String[] to, String[] cc, String subject,
			String content, String templatePath, Map templateMap, boolean isHtml) {
		MimeMessage mailMessage = mailSender.createMimeMessage();
		try {
	...
	public void sendMimeMail(String from, String[] to, String[] cc, String subject,
			String content, boolean isHtml, File[] inlineFiles, File[] attachFiles) {
		MimeMessage mailMessage = mailSender.createMimeMessage();
	...
	private void addAttachments(File[] attachFiles, MimeMessageHelper messageHelper)
	...
	private void addInlines(File[] inlineFiles, MimeMessageHelper messageHelper)
			throws MessagingException {
		if (inlineFiles != null) {
